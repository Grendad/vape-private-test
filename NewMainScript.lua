...
local customdir = (shared.VapePrivate and "vapeprivate/" or "vape/private")
...
if shared.VapeExecuted then
	error("Vape private Already Injected")
	return
else
	shared.VapeprivateExecuted = true
end
...
if isfolder("vape/assets") == false then
	makefolder("vape Private/assets")
end
